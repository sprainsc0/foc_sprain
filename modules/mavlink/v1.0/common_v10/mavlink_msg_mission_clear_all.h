...
{
    return mavlink_msg_mission_clear_all_pack(system_id, component_id, msg, (uint8_t )(mission_clear_all->target_system), (uint8_t )(mission_clear_all->target_component));
}
...
{
    return mavlink_msg_mission_clear_all_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_clear_all->target_system), (uint8_t )(mission_clear_all->target_component));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_CLEAR_ALL, (const char *)mission_clear_all, MAVLINK_MSG_ID_MISSION_CLEAR_ALL_LEN);
#endif
#endif
}
