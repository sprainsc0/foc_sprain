...
{
    return mavlink_msg_vision_position_estimate_pack(system_id, component_id, msg, (uint64_t )(vision_position_estimate->usec), (float )(vision_position_estimate->x), (float )(vision_position_estimate->y), (float )(vision_position_estimate->z), (float )(vision_position_estimate->roll), (float )(vision_position_estimate->pitch), (float )(vision_position_estimate->yaw));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE, (const char *)vision_position_estimate, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE_LEN);
#endif
#endif
}
