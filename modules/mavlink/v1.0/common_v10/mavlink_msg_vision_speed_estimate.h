...
{
    return mavlink_msg_vision_speed_estimate_pack(system_id, component_id, msg, (uint64_t )(vision_speed_estimate->usec), (float )(vision_speed_estimate->x), (float )(vision_speed_estimate->y), (float )(vision_speed_estimate->z));
}
...
{
    return mavlink_msg_vision_speed_estimate_pack_chan(system_id, component_id, chan, msg, (uint64_t )(vision_speed_estimate->usec), (float )(vision_speed_estimate->x), (float )(vision_speed_estimate->y), (float )(vision_speed_estimate->z));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE, (const char *)vision_speed_estimate, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE_LEN);
#endif
#endif
}
