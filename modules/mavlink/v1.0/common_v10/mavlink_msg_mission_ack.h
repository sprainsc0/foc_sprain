...
{
    return mavlink_msg_mission_ack_pack(system_id, component_id, msg, (uint8_t )(mission_ack->target_system), (uint8_t )(mission_ack->target_component), (uint8_t )(mission_ack->type));
}
...
{
    return mavlink_msg_mission_ack_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_ack->target_system), (uint8_t )(mission_ack->target_component), (uint8_t )(mission_ack->type));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_ACK, (const char *)mission_ack, MAVLINK_MSG_ID_MISSION_ACK_LEN);
#endif
#endif
}
