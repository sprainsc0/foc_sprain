...
{
    return mavlink_msg_set_gps_global_origin_pack(system_id, component_id, msg, (uint8_t )(set_gps_global_origin->target_system), (int32_t )(set_gps_global_origin->latitude), (int32_t )(set_gps_global_origin->longitude), (int32_t )(set_gps_global_origin->altitude));
}
...
{
    return mavlink_msg_set_gps_global_origin_pack_chan(system_id, component_id, chan, msg, (uint8_t )(set_gps_global_origin->target_system), (int32_t )(set_gps_global_origin->latitude), (int32_t )(set_gps_global_origin->longitude), (int32_t )(set_gps_global_origin->altitude));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN, (const char *)set_gps_global_origin, MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_LEN);
#endif
#endif
}
