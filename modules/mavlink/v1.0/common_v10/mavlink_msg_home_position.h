...
{
    return mavlink_msg_home_position_pack(system_id, component_id, msg, (int32_t )(home_position->latitude), (int32_t )(home_position->longitude), (int32_t )(home_position->altitude), (float )(home_position->x), (float )(home_position->y), (float )(home_position->z), (const float *)(home_position->q), (float )(home_position->approach_x), (float )(home_position->approach_y), (float )(home_position->approach_z));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HOME_POSITION, (const char *)home_position, MAVLINK_MSG_ID_HOME_POSITION_LEN);
#endif
#endif
}
