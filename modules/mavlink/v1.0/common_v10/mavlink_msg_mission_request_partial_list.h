...
{
    return mavlink_msg_mission_request_partial_list_pack(system_id, component_id, msg, (uint8_t )(mission_request_partial_list->target_system), (uint8_t )(mission_request_partial_list->target_component), (int16_t )(mission_request_partial_list->start_index), (int16_t )(mission_request_partial_list->end_index));
}
...
{
    return mavlink_msg_mission_request_partial_list_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_request_partial_list->target_system), (uint8_t )(mission_request_partial_list->target_component), (int16_t )(mission_request_partial_list->start_index), (int16_t )(mission_request_partial_list->end_index));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_REQUEST_PARTIAL_LIST, (const char *)mission_request_partial_list, MAVLINK_MSG_ID_MISSION_REQUEST_PARTIAL_LIST_LEN);
#endif
#endif
}
