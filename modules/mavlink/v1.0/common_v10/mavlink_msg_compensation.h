...
#define MAVLINK_MSG_ID_COMPENSATION 57
...
#define MAVLINK_MSG_ID_57_LEN 36
#define MAVLINK_MSG_ID_57_MIN_LEN 36

#define MAVLINK_MSG_ID_COMPENSATION_CRC 88
#define MAVLINK_MSG_ID_57_CRC 88
...
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_COMPENSATION_LEN);
#endif
}
...
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_COMPENSATION_LEN);
#endif
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_COMPENSATION, buf, MAVLINK_MSG_ID_COMPENSATION_LEN);
#endif
#else
    mavlink_compensation_t packet;
    packet.time_usec = time_usec;
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_COMPENSATION, (const char *)&packet, MAVLINK_MSG_ID_COMPENSATION_LEN);
#endif
#endif
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_COMPENSATION, (const char *)compensation, MAVLINK_MSG_ID_COMPENSATION_LEN);
#endif
#endif
}
