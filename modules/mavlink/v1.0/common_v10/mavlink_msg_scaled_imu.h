...
{
    return mavlink_msg_scaled_imu_pack(system_id, component_id, msg, (uint32_t )(scaled_imu->time_boot_ms), (int16_t )(scaled_imu->xacc), (int16_t )(scaled_imu->yacc), (int16_t )(scaled_imu->zacc), (int16_t )(scaled_imu->xgyro), (int16_t )(scaled_imu->ygyro), (int16_t )(scaled_imu->zgyro), (int16_t )(scaled_imu->xmag), (int16_t )(scaled_imu->ymag), (int16_t )(scaled_imu->zmag));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SCALED_IMU, (const char *)scaled_imu, MAVLINK_MSG_ID_SCALED_IMU_LEN);
#endif
#endif
}
