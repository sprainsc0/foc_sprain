...
{
    return mavlink_msg_mission_request_int_pack(system_id, component_id, msg, (uint8_t )(mission_request_int->target_system), (uint8_t )(mission_request_int->target_component), (uint16_t )(mission_request_int->seq));
}
...
{
    return mavlink_msg_mission_request_int_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_request_int->target_system), (uint8_t )(mission_request_int->target_component), (uint16_t )(mission_request_int->seq));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_REQUEST_INT, (const char *)mission_request_int, MAVLINK_MSG_ID_MISSION_REQUEST_INT_LEN);
#endif
#endif
}
