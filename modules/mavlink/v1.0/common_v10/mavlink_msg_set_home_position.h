...
{
    return mavlink_msg_set_home_position_pack(system_id, component_id, msg, (uint8_t )(set_home_position->target_system), (int32_t )(set_home_position->latitude), (int32_t )(set_home_position->longitude), (int32_t )(set_home_position->altitude), (float )(set_home_position->x), (float )(set_home_position->y), (float )(set_home_position->z), (const float *)(set_home_position->q), (float )(set_home_position->approach_x), (float )(set_home_position->approach_y), (float )(set_home_position->approach_z));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_HOME_POSITION, (const char *)set_home_position, MAVLINK_MSG_ID_SET_HOME_POSITION_LEN);
#endif
#endif
}
