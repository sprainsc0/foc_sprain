...
{
    return mavlink_msg_mission_request_pack(system_id, component_id, msg, (uint8_t )(mission_request->target_system), (uint8_t )(mission_request->target_component), (uint16_t )(mission_request->seq));
}
...
{
    return mavlink_msg_mission_request_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_request->target_system), (uint8_t )(mission_request->target_component), (uint16_t )(mission_request->seq));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_REQUEST, (const char *)mission_request, MAVLINK_MSG_ID_MISSION_REQUEST_LEN);
#endif
#endif
}
