...
#define MAVLINK_MSG_ID_CONTROL 56
...
#define MAVLINK_MSG_ID_56_LEN 33
#define MAVLINK_MSG_ID_56_MIN_LEN 33

#define MAVLINK_MSG_ID_CONTROL_CRC 86
#define MAVLINK_MSG_ID_56_CRC 86
...
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_CONTROL_LEN);
#endif
}
...
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_CONTROL_LEN);
#endif
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CONTROL, buf, MAVLINK_MSG_ID_CONTROL_LEN);
#endif
#else
    mavlink_control_t packet;
    packet.time_usec = time_usec;
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CONTROL, (const char *)&packet, MAVLINK_MSG_ID_CONTROL_LEN);
#endif
#endif
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CONTROL, (const char *)control, MAVLINK_MSG_ID_CONTROL_LEN);
#endif
#endif
}
