...
#define MAVLINK_MSG_ID_FCINFO 58
...
#define MAVLINK_MSG_ID_58_LEN 37
#define MAVLINK_MSG_ID_58_MIN_LEN 37

#define MAVLINK_MSG_ID_FCINFO_CRC 146
#define MAVLINK_MSG_ID_58_CRC 146
...
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_FCINFO_LEN);
#endif
}
...
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_FCINFO_LEN);
#endif
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FCINFO, buf, MAVLINK_MSG_ID_FCINFO_LEN);
#endif
#else
    mavlink_fcinfo_t packet;
    packet.time_usec = time_usec;
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FCINFO, (const char *)&packet, MAVLINK_MSG_ID_FCINFO_LEN);
#endif
#endif
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FCINFO, (const char *)fcinfo, MAVLINK_MSG_ID_FCINFO_LEN);
#endif
#endif
}
