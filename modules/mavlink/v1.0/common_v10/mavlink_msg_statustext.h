...
{
    return mavlink_msg_statustext_pack(system_id, component_id, msg, (uint8_t )(statustext->severity), (const char *)(statustext->text));
}
...
{
    return mavlink_msg_statustext_pack_chan(system_id, component_id, chan, msg, (uint8_t )(statustext->severity), (const char *)(statustext->text));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_STATUSTEXT, (const char *)statustext, MAVLINK_MSG_ID_STATUSTEXT_LEN);
#endif
#endif
}
