...
{
    return mavlink_msg_scaled_pressure2_pack(system_id, component_id, msg, (uint32_t )(scaled_pressure2->time_boot_ms), (float )(scaled_pressure2->press_abs), (float )(scaled_pressure2->press_diff), (int16_t )(scaled_pressure2->temperature));
}
...
{
    return mavlink_msg_scaled_pressure2_pack_chan(system_id, component_id, chan, msg, (uint32_t )(scaled_pressure2->time_boot_ms), (float )(scaled_pressure2->press_abs), (float )(scaled_pressure2->press_diff), (int16_t )(scaled_pressure2->temperature));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SCALED_PRESSURE2, (const char *)scaled_pressure2, MAVLINK_MSG_ID_SCALED_PRESSURE2_LEN);
#endif
#endif
}
