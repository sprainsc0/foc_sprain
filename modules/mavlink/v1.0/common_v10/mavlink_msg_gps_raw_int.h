...
{
    return mavlink_msg_gps_raw_int_pack(system_id, component_id, msg, (uint64_t )(gps_raw_int->time_usec), (uint8_t )(gps_raw_int->fix_type), (int32_t )(gps_raw_int->lat), (int32_t )(gps_raw_int->lon), (int32_t )(gps_raw_int->alt), (uint16_t )(gps_raw_int->eph), (uint16_t )(gps_raw_int->epv), (uint16_t )(gps_raw_int->vel), (uint16_t )(gps_raw_int->cog), (uint8_t )(gps_raw_int->satellites_visible));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_RAW_INT, (const char *)gps_raw_int, MAVLINK_MSG_ID_GPS_RAW_INT_LEN);
#endif
#endif
}
