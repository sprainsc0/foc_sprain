...
{
    return mavlink_msg_global_vision_position_estimate_pack(system_id, component_id, msg, (uint64_t )(global_vision_position_estimate->usec), (float )(global_vision_position_estimate->x), (float )(global_vision_position_estimate->y), (float )(global_vision_position_estimate->z), (float )(global_vision_position_estimate->roll), (float )(global_vision_position_estimate->pitch), (float )(global_vision_position_estimate->yaw));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE, (const char *)global_vision_position_estimate, MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE_LEN);
#endif
#endif
}
