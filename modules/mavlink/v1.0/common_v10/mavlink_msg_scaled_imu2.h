...
{
    return mavlink_msg_scaled_imu2_pack(system_id, component_id, msg, (uint32_t )(scaled_imu2->time_boot_ms), (int16_t )(scaled_imu2->xacc), (int16_t )(scaled_imu2->yacc), (int16_t )(scaled_imu2->zacc), (int16_t )(scaled_imu2->xgyro), (int16_t )(scaled_imu2->ygyro), (int16_t )(scaled_imu2->zgyro), (int16_t )(scaled_imu2->xmag), (int16_t )(scaled_imu2->ymag), (int16_t )(scaled_imu2->zmag));
}
...
{
    return mavlink_msg_scaled_imu2_pack_chan(system_id, component_id, chan, msg, (uint32_t )(scaled_imu2->time_boot_ms), (int16_t )(scaled_imu2->xacc), (int16_t )(scaled_imu2->yacc), (int16_t )(scaled_imu2->zacc), (int16_t )(scaled_imu2->xgyro), (int16_t )(scaled_imu2->ygyro), (int16_t )(scaled_imu2->zgyro), (int16_t )(scaled_imu2->xmag), (int16_t )(scaled_imu2->ymag), (int16_t )(scaled_imu2->zmag));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SCALED_IMU2, (const char *)scaled_imu2, MAVLINK_MSG_ID_SCALED_IMU2_LEN);
#endif
#endif
}
