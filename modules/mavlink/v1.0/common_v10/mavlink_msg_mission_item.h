...
{
    return mavlink_msg_mission_item_pack(system_id, component_id, msg, (uint8_t )(mission_item->target_system), (uint8_t )(mission_item->target_component), (uint16_t )(mission_item->seq), (uint8_t )(mission_item->frame), (uint16_t )(mission_item->command), (uint8_t )(mission_item->current), (uint8_t )(mission_item->autocontinue), (float )(mission_item->param1), (float )(mission_item->param2), (float )(mission_item->param3), (float )(mission_item->param4), (float )(mission_item->x), (float )(mission_item->y), (float )(mission_item->z));
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_ITEM, (const char *)mission_item, MAVLINK_MSG_ID_MISSION_ITEM_LEN);
#endif
#endif
}
