...
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_CALIBRATE_STATUS_LEN);
#endif
}
...
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_CALIBRATE_STATUS_LEN);
#endif
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CALIBRATE_STATUS, buf, MAVLINK_MSG_ID_CALIBRATE_STATUS_LEN);
#endif
#else
    mavlink_calibrate_status_t packet;
    packet.param1 = param1;
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CALIBRATE_STATUS, (const char *)&packet, MAVLINK_MSG_ID_CALIBRATE_STATUS_LEN);
#endif
#endif
}
...
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CALIBRATE_STATUS, (const char *)calibrate_status, MAVLINK_MSG_ID_CALIBRATE_STATUS_LEN);
#endif
#endif
}
