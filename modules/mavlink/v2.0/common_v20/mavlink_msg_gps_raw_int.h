...
{
    return mavlink_msg_gps_raw_int_pack(system_id, component_id, msg, (uint64_t )(gps_raw_int->time_usec), (uint8_t )(gps_raw_int->fix_type), (int32_t )(gps_raw_int->lat), (int32_t )(gps_raw_int->lon), (int32_t )(gps_raw_int->alt), (uint16_t )(gps_raw_int->eph), (uint16_t )(gps_raw_int->epv), (uint16_t )(gps_raw_int->vel), (uint16_t )(gps_raw_int->cog), (uint8_t )(gps_raw_int->satellites_visible), (int32_t )(gps_raw_int->alt_ellipsoid), (uint32_t )(gps_raw_int->h_acc), (uint32_t )(gps_raw_int->v_acc), (uint32_t )(gps_raw_int->vel_acc), (uint32_t )(gps_raw_int->hdg_acc));
}
