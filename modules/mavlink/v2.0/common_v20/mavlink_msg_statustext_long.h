...
{
    return mavlink_msg_statustext_long_pack(system_id, component_id, msg, (uint8_t )(statustext_long->severity), (const char *)(statustext_long->text));
}
...
{
    return mavlink_msg_statustext_long_pack_chan(system_id, component_id, chan, msg, (uint8_t )(statustext_long->severity), (const char *)(statustext_long->text));
}
