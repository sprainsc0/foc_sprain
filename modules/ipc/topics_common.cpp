...
//         name                       uORB struct                      serial id       is multi  buffer    sem      buffer
IPC_DEFINE(actuator_notify,           struct actuator_notify_s,           0,            false,    false,  false,      0);
IPC_DEFINE(parameter_update,          struct parameter_update_s,          1,            false,    false,  false,      0);
IPC_DEFINE(foc_command,               struct foc_command_s,               2,            false,    false,  false,      0);
IPC_DEFINE(telemetry_status,          struct telemetry_status_s,          3,            false,    false,  false,      0);
...
IPC_DEFINE(uavcan_command_request,    struct uavcan_command_request_s,    9,            false,    true,   false,      3);
IPC_DEFINE(uavcan_command_response,   struct uavcan_command_response_s,   10,           false,    true,   false,      3);